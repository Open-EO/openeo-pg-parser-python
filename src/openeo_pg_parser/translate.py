            ...
            if "process_id" in value.keys():  # process node found
                ...
                if node_ids:
                    ...
                    if node.expects_parent_input:
                        ...
                        node, data_parent_node = resolve_from_parameter(node, current_graph,
                                                                        global_parameters=global_parameters)
                        if data_parent_node:  # only create data link when there is a parent node
...
#             parent_nodes = process_graph.lineage(node, link="process", ancestors=False, include_node=False)
